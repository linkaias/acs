...
<script setup>
  ...
  import {reqGetChartByAllGroupId} from "@/api/chart";
  ...
  const loadChart = async ()=>{
    ...
    loading.value = true;
    let res = await reqGetChartByAllGroupId(ChartParams.time_dimension, ChartParams.begin_time,ChartParams.end_time);
    loading.value = false;
    let data = res.data;
